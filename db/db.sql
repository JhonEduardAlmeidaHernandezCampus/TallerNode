...
ALTER TABLE inventarios ADD CONSTRAINT fk_inventarios_created_users FOREIGN KEY (created_by) REFERENCES users (id);
ALTER TABLE inventarios ADD CONSTRAINT fk_inventarios_update_user FOREIGN KEY (update_by) REFERENCES users (id);
ALTER TABLE inventarios ADD CONSTRAINT fk_inventarios_producto_productos FOREIGN KEY (id_producto) REFERENCES productos (id);
ALTER TABLE inventarios ADD CONSTRAINT fk_inventarios_bodega_bodegas FOREIGN KEY (id_bodega) REFERENCES bodegas (id);
ALTER TABLE bodegas ADD CONSTRAINT fk_bodegas_responsable_user FOREIGN KEY (id_responsable) REFERENCES users (id);
ALTER TABLE bodegas ADD CONSTRAINT fk_bodegas_created_user FOREIGN KEY (created_by) REFERENCES users (id);
ALTER TABLE bodegas ADD CONSTRAINT fk_bodegas_update_user FOREIGN KEY (update_by) REFERENCES users (id);
ALTER TABLE historiales ADD CONSTRAINT fk_historiales_inventario_inventarios FOREIGN KEY (id_inventario) REFERENCES inventarios (id);
ALTER TABLE historiales ADD CONSTRAINT fk_historiales_origen_bodegas FOREIGN KEY (id_bodega_origen) REFERENCES bodegas (id);
ALTER TABLE historiales ADD CONSTRAINT fk_historiales_destino_bodegas FOREIGN KEY (id_bodega_destino) REFERENCES bodegas (id);
ALTER TABLE historiales ADD CONSTRAINT fk_historiales_created_users FOREIGN KEY (created_by) REFERENCES users (id);
ALTER TABLE historiales ADD CONSTRAINT fk_historiales_update_users FOREIGN KEY (update_by) REFERENCES users (id);


/* SE AGREGA LOS DATOS DE LA TABLA DE USERS */
...
/* SE AGREGA LOS DATOS DE LA TABLA DE PRODUCTOS */
...
/* SE AGREGA LOS DATOS DE LA TABLA DE HISTORIALES */
